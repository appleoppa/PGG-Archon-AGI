...
CRATES=(hermes_pgg_status hermes_pgg_ecc hermes_pgg_overlay hermes_pgg_ralph hermes_pgg_pilotdeck hermes_pgg_github_evolution_gate hermes_pgg_kanban_gate hermes_pgg_context_learning_gate hermes_pgg_context_formula_gate hermes_pgg_global_trajectory_gate hermes_pgg_personal_agent_training_gate hermes_pgg_research_engine hermes_pgg_apex_delta_e_gate hermes_pgg_memory_swrs_gate hermes_pgg_team_memory_gate hermes_pgg_department_memory_apply_gate hermes_pgg_department_memory_distillation_gate hermes_pgg_department_memory_review_gate hermes_pgg_evomaster_gate hermes_pgg_tiangong_gate)
