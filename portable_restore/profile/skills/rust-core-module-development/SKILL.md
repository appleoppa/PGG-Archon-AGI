...
- `references/pilotdeck-private-sync-and-hermes-absorption-20260606.md` — PilotDeck 私有 GitHub clean snapshot 同步、LFS 边界、自动 hook、Hermes→PilotDeck Rust 吸收桥、target 排除与远程读回验证模式。
