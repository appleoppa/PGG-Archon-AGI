...
def test_runtime_status_surface_passes_when_all_surfaces_present_and_safe():
    report = build_apex_runtime_status_surface(
    ...
    assert report["schema"] == "ApexRuntimeStatusSurface/v1"
