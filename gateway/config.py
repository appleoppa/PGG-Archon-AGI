    ...
    try:
        ...
        if config_yaml_path.exists():
            ...
            for plat in _shared_loop_targets:
                ...
                if plat == Platform.FEISHU and "rigorous_card_enabled" in platform_cfg:
                    bridged["rigorous_card_enabled"] = platform_cfg["rigorous_card_enabled"]
                if plat == Platform.FEISHU and "cardkit_streaming_enabled" in platform_cfg:
                    bridged["cardkit_streaming_enabled"] = platform_cfg["cardkit_streaming_enabled"]
